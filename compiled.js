...
var Scene1 = function (_Phaser$State) {
    inherits(Scene1, _Phaser$State);

    function Scene1() {
        classCallCheck(this, Scene1);
        return possibleConstructorReturn(this, (Scene1.__proto__ || Object.getPrototypeOf(Scene1)).apply(this, arguments));
    }
...
var Game = function (_Phaser$Game) {
    ...
    function Game() {
        ...
        _this.state.add('Scene1', Scene1, false);
        _this.state.start('Scene1');
        return _this;
    }
