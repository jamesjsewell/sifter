...
class LevelComplete {
    ...
    constructor(context){
        ...
        this.score = this.theGame.completion_time
        this.create_completion_time
    ...
    create_completion_time(){
        ...
        this.nextButton = this.theGame.add.button(this.width/2, this.height/2, "atlas", this.next, this, 'next_button2.png', 'next_button1.png');
